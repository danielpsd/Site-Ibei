...
export const EVENTS_DEFAULTS: EventsContent = {
  headline: "Próximos eventos da nossa comunidade",
  items: [
    { day: "11", month: "MAI", title: "Conferência Vida Nova 2026", desc: "Três dias de imersão espiritual com pregadores nacionais e internacionais. Um encontro que vai transformar sua vida.", time: "Sexta a Domingo · 19h", location: "Sede Principal", tag: "CONFERÊNCIA", highlight: true },
    { day: "18", month: "MAI", title: "Retiro de Casais", desc: "Um fim de semana especial para fortalecer o seu casamento e renovar o compromisso com Deus e com o cônjuge.", time: "Sábado e Domingo", location: "Sítio Recanto Verde", tag: "RETIRO", highlight: false },
    { day: "25", month: "MAI", title: "Culto de Jovens — Geração", desc: "A noite dos jovens com louvor contemporâneo, pregação relevante e muito networking entre a galera da fé.", time: "Sábado · 20h", location: "Sede Principal", tag: "JOVENS", highlight: false },
    { day: "01", month: "JUN", title: "Escola de Líderes", desc: "Capacitação intensiva para líderes de células e ministérios. Inscrições abertas para membros comprometidos.", time: "Domingo · 14h", location: "Sala de Treinamento", tag: "CAPACITAÇÃO", highlight: false },
  ],
};

export default function EventsSection() {
  const sectionRef = useRef<HTMLDivElement>(null);
  const content = useSiteContent<EventsContent>("events", EVENTS_DEFAULTS);
